...
#text-white {color: #fff;}
            ...
            <?php
                $fetchingActiveElections = mysqli_query($db, "SELECT * FROM elections WHERE id = '".$election_id."'")
            ...
            <h3>Voting Details</h3>
                    <?php
                        ...
                        if($number_of_votes > 0)
                        {
                            ...
                            while($data = mysqli_fetch_assoc($fetchingVoteDetails))
                            {
                                ...
                                $fetchingUsername = mysqli_query($db, "SELECT * FROM users WHERE id='".
                                $voters_id."'") or die(mysqli_error($db));
                                ...
                                $fetchingUsername = mysqli_query($db, "SELECT * FROM candidate_details WHERE id='".
                                $candidate_id."'") or die(mysqli_error($db));
                                $isDataAvailable = mysqli_num_rows($fetchingUcandidatename);
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            echo "No any vote detail available!";
                        }
                        ?>       
            </table>
        </div>
