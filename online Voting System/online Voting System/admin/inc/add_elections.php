...
<?php
     ...
     {
        $d_id = $_GET['delete_id'];
        mysqli_query("DELETE FROM elections WHERE id = '".$d_id."'") OR die(mysqli_error($db));
...
<div class="row my-3">
    <div class="col-4">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <input type="text" onfocus="this.type='Date'" name="starting_date" placeholder="starting_date" class="form-control" required />
            </div>
            <div class="form-group">
                <input type="text" onfocus="this.type='Date'" name="ending_date" placeholder="Election Topic" class="form-control" required />
            </div>  
