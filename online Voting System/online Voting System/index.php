<?php
     ...
     while($data = mysqli_fetch_assoc($fetchingElections))
     {
        ...
        {
            mysqli_query($db,"UPDATE elections SET status = 'Expired' WHERE id='".$election_id."'") OR 
            die(mysqli_error($db));
        }
        ...
        {
            //update
            mysqli_query($db, "UPDATE elections SET status = 'Active' WHERE id = '".$election_id."'") OR
            die(mysqli_error($db));
        }
...
<head>
    ...
    <link rel="stylrsheet" href="assest/css/style.css">
</head>
			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="assest/Images/logo.gif" class="brand_logo" alt="Logo">
					</div>
				</div>
...
<?php
    require_once("admin/inc/Config.php");
      ...
      if(isset($_POST['sign_up_btn']))
      {
         ...
         {
              // Insert Query
              mysqli_query($db, "INSERT INTO users(username, contact_no, password, user_role) VALUES('".
              $su_username."', '".$su_contact_no."', '".$su_password."', '".$user_role."')") or die
              (mysqli_error($db));
      ...
      }else if(isset($_POST['loginBtn']))
      {
        ...
        //Query Fetch / SELECT
        $fetchingData = mysqli_query($db, "SELECT * FROM users WHERE contact_no = '".$contact_no."'") or die
        (mysqli_error($db));
